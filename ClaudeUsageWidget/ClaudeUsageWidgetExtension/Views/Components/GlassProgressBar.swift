...
#Preview {
    VStack(spacing: 20) {
        GlassProgressBar(progress: 0.3, fillColor: .blue)

        GlassProgressBar(progress: 0.53, fillColor: .purple)

        GlassProgressBar(progress: 0.23, fillColor: .orange)

        GlassProgressBar(progress: 0.75, fillColor: .green, height: 12)

        GlassProgressBar(progress: 1.0, fillColor: .red, height: 6)
    }
    .padding()
